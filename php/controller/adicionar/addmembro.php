...
$membro_actividade = $_REQUEST["membro_actividade"];
                ...
                if ($adicionarEndereco) {
                    ...
                    if ($adicionarDocumento) {
                        ...
                        if ($adicionarHerdeiro) {
                            ...
                            $adicionarMembro = adicionar(array("membro_codigo", "membro_nome", "membro_actividade", "membro_sexo",
                                "codigo_herdeiro", "codigo_endereco", "codigo_documento", "codigo_tecnico", "codigo_usuario", "membro_data_criacao"),
                                array($membro_codigo, $membro_nome, $membro_actividade, $membro_sexo, $herdeiro_codigo, $endereco_codigo, $documento_codigo,$codigo_tecnico, $usuario_codigo, $usuario_data_criacao), "membro_roscas");
                            if ($adicionarMembro) {
